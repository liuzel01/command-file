...
# Check Memory and CPU usage rate
...
echo -e '\E[32m'"Total memory size:" "\033[37m $TOTAL \033[0m"
echo -e '\E[32m'"Memory usage：" "\033[37m $USED \033[0m"
echo -e '\E[32m'"Memory usage rate: " "\033[37m $USEDRAT \033[0m"
echo -e '\E[32m'"CPU usage rate：" "\033[37m $CPUU \033[0m"
